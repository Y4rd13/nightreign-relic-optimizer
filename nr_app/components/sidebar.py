        ...
        rx.accordion.root(
            ...
            _section(
                ...
                rx.cond(
                    ...
                    rx.hstack(
                        rx.icon(tag="bookmark", size=11, color=PAL["mauve"]),
                        rx.text("Editing", color=PAL["overlay1"],
                                font_size="0.72rem"),
                        rx.text(State.active_preset_name,
                ...
                rx.hstack(
                    rx.el.button(
                        rx.hstack(
                            ...
                            rx.text("Save", font_weight="600"),
                            spacing="1",
                            align="center",
                        ),
                        on_click=State.save_active_preset,
                        disabled=State.active_preset_name == "",
                        title=rx.cond(
                            State.active_preset_name != "",
                            "Overwrite '" + State.active_preset_name
                            + "' with the current configuration",
                            "Load a build first to enable in-place save",
                        ),
                        style={
                            "background": rx.cond(
                                State.active_preset_name != "",
                                PAL["mauve"], "transparent",
                            ),
                            "border": rx.cond(
                                State.active_preset_name != "",
                    ...
                    rx.el.button(
                        rx.hstack(
                            ...
                            rx.text("Save as…", font_weight="600"),
                            spacing="1",
                            align="center",
                        ),
                        on_click=State.open_preset,
                        title="Save the current build as a new preset",
                        style={
                            "background": "transparent",
                            "border": f"1px solid {PAL['surface1']}",
                            "color": PAL["lavender"],
